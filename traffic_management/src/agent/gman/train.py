...
def train():
    ...
    log_file = os.path.join(config.PATH_TO_RECORDS, f"{config.EXPERIMENT.SCENARIO_NAME}_gman_log")
    ...
    X, TE, label, is_training = model.placeholder(config.AGENT.HISTORY_STEPS, config.AGENT.PREDICTION_STEPS, N)
