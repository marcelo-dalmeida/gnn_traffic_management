...
def train():
    ...
    train_dr, train_fpr, train_f_score, train_mttd = utils.calculate_detection_metrics(disc_clas_trainPred, traintrafpatY, detection_times)
    val_dr, val_fpr, val_f_score, val_mttd = utils.calculate_detection_metrics(disc_clas_valPred, valtrafpatY, detection_times)
    test_dr, test_fpr, test_f_score, test_mttd = utils.calculate_detection_metrics(disc_clas_testPred, testtrafpatY, detection_times)
